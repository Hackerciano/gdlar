...
(function ($, context) {
  ...
  function init() {
    ...
    var donutData = [
      { name: "Cultura", id: 1, quantity: 6, percentage: 25 },
      { name: "Gastronomía", id: 2, quantity: 3, percentage: 48 },
      { name: "Recreación", id: 3, quantity: 2, percentage: 6 },
      { name: "Eventos", id: 4, quantity: 1, percentage: 11 },
      { name: "Historia", id: 5, quantity: 3, percentage: 10 },
    ];
